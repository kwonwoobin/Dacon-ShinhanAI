...
class GaonchartSpider(scrapy.Spider):
    ...
    def start_requests(self):
        ...
        # week_date_list = week_date_list[2:]

        week_key_list = []
        for i in range(len(week_date_list)):
            ...
            week_key_list.append(week_key.attrs['value'])
            ...
            if year == 2023:
                for week_num in range(15,0,-1):
                    ...
                    yield scrapy.Request(url = self.base_url + query_page_url, 
                                        ...
                                        meta={'week_date_list': week_date_list, 'year':year, 'week_num':week_num})
    ...
    def page_parse(self, response):
        ...
        for i in range(1,201):
            ...
            idx += 1
            start_date, end_date = week_date_list[idx].split('~')
